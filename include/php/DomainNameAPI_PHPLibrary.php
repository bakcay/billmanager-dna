...
class DomainNameAPI_PHPLibrary
{
    ...
    const DEFAULT_NAMESERVERS = [
        'ns1.pmdomainnameapi.com',
        'ns2.pmdomainnameapi.com',
    ];
     ...
     */
    private string $serviceUrl         = "https://whmcs.pmdomainnameapi.com/DomainApi.svc";
     ...
     *     @type array "Registrant"     Similar structure as Administrative
     * }
     * @param array $nameServers       Array of nameservers (default: ["dns.pmdomainnameapi.com", "web.pmdomainnameapi.com"])
